...
class Config(object):
    ...
    CLIENT_SECRET = os.environ.get('CLIENT_SECRET') or 'ENTER_SQL_SERVER_PASSWORD'
    ...
    AUTHORITY = os.environ.get('AUTHORITY') or 'ENTER_SQL_SERVER_PASSWORD'

    CLIENT_ID = os.environ.get('CLIENT_ID') or 'ENTER_SQL_SERVER_PASSWORD'
